...
hdfs dfs -mkdir /user/mapreduce/ex06
hdfs dfs -mkdir /user/mapreduce/ex06/input

INPUT_FILE_NAME="NASA_access_log_Jul95"


INPUT_PATH="/user/mapreduce/ex06/input/datas"
OUTPUT_PATH="/user/mapreduce/ex06/output"
DATA_SOURCE_PATH="./datas"
MAIN_JAVA_FILE_NAME="CorrelationMessageAndHits.java"
MAIN_CLASS_NAME="CorrelationMessageAndHits"
JAR_NAME="Correlationjar.jar"
